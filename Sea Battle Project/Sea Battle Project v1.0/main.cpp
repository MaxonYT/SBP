...
#include <typeinfo>
#include <iostream>
#include "olcPixelGameEngine.h" //890 строчка - функции дл€ рисовани€
...
struct Obj_t
{
    ...
    olc::vf2d pos; // точка, в которую будет помещатьс€ наш кусок декала на экране
    olc::vf2d source_pos; // лева€ верхн€€ точка куска декала  i.e.: (0, 100)
    ...
    float fAngle = 0.0f; // угол вращени€
    olc::vf2d center; // центр, относительно которого будет вращатьс€ декал
};
...
public:
    ...
    bool OnUserCreate() override
    {
        ...
        dyn_boat_1 = {
            std::make_shared<olc::Decal>(tempDynImg1), //475 - х между корабл€ми
            m_BoatPos,
            {475, 0}, // {0, 0}
